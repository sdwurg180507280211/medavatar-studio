...
const ATTR_TEXT: Record<string, string> = {
  ...
  'Comparison left label': '左侧实体标签',
  'Comparison left value': '左侧实体数值',
  'Comparison left context': '左侧实体补充说明',
  'Comparison right label': '右侧实体标签',
  'Comparison right value': '右侧实体数值',
  'Comparison right context': '右侧实体补充说明',
  'Avatar scale': '数字人缩放',
};
